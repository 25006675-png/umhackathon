  ...
  const entries: Omit<HistoryEntry, 'timestamp' | 'reading_date'>[] = [
    {
      ...
      feed_intake_kg: 52.4,
      water_intake_liters: 106,
      ventilation_condition: 'normal',
      behaviour_flags: [],
      farmer_notes: 'Routine check. Birds active and feeding normally.',
      top_driver: 'Normal',
    },
    {
      score: 24,
      ...
      feed_intake_kg: 52.1,
      water_intake_liters: 104,
      ventilation_condition: 'normal',
      behaviour_flags: [],
      farmer_notes: 'No obvious issue. Litter still dry.',
      top_driver: 'Normal',
    },
    {
      score: 27,
      ...
      ventilation_condition: 'normal',
      behaviour_flags: [],
      farmer_notes: 'Slightly warmer in the afternoon but flock still steady.',
      top_driver: 'Normal',
    },
    {
      score: 33,
      ...
      farmer_notes: 'Water line seems lighter than usual. Birds still look okay.',
    ...
    },
    {
      ...
      behaviour_flags: ['water_change'],
      farmer_notes: 'Mild ammonia smell near the back section. Intake softer than baseline.',
      top_driver: 'Water intake',
    },
    {
      score: 46,
      ...
      feed_intake_kg: 48.7,
      water_intake_liters: 94,
      ventilation_condition: 'mild',
      behaviour_flags: ['water_change', 'reduced_movement'],
      farmer_notes: 'Some birds are quieter and staying down longer between movements.',
    ...
    },
    {
      ...
      feed_intake_kg: 47.5,
      water_intake_liters: 92,
      ventilation_condition: 'mild',
      behaviour_flags: ['water_change', 'reduced_movement'],
      farmer_notes: 'Feed tray not clearing as fast. More birds look dull by evening.',
      top_driver: 'Feed drop',
    },
    {
      score: 61,
      ...
      farmer_notes: 'Quiet breathing sounds heard in one section. Stronger smell after noon.',
    ...
    },
    {
      ...
      feed_intake_kg: 44.8,
      water_intake_liters: 87,
      ventilation_condition: 'strong',
      behaviour_flags: ['water_change', 'reduced_movement', 'abnormal_sounds'],
      farmer_notes: 'More birds staying clustered. Feed and water both trailing.',
      top_driver: 'Environment',
    },
    {
      score: 74,
      ...
      feed_intake_kg: 43.6,
      water_intake_liters: 85,
      ventilation_condition: 'strong',
      behaviour_flags: ['water_change', 'abnormal_sounds', 'huddling_panting', 'reduced_movement'],
      farmer_notes: 'Birds are quieter, some panting, some respiratory sound. House feels heavy.',
    ...
    },
    {
      ...
      feed_intake_kg: 42.8,
      water_intake_liters: 84,
      ventilation_condition: 'sensor_high',
      behaviour_flags: ['water_change', 'abnormal_sounds', 'huddling_panting', 'reduced_movement'],
      farmer_notes: 'Sensor alarm on ammonia. Birds panting more by late afternoon.',
      top_driver: 'Environment',
    },
    {
      score: 84,
      ...
      status: 'official',
      check_count: 3,
      temperature_celsius: 33.6,
      feed_intake_kg: 41.9,
      water_intake_liters: 82,
      ventilation_condition: 'sensor_high',
      behaviour_flags: ['water_change', 'abnormal_sounds', 'huddling_panting', 'reduced_movement'],
      farmer_notes: 'Condition worsening. Mortality climbing and flock noticeably inactive.',
      top_driver: 'Mortality',
    },
    {
      score: 81,
      level: LEVEL_FOR(81),
      ...
      farmer_notes: 'Some response after ventilation adjustment, but flock still under pressure.',
      top_driver: 'Environment',
    },
    {
      score: 84,
      ...
      ventilation_condition: 'strong',
      behaviour_flags: ['abnormal_sounds', 'huddling_panting', 'reduced_movement'],
      farmer_notes: 'Latest check still critical. Feed has not recovered and birds remain subdued.',
      top_driver: 'Feed + temp + behaviour',
    },
  ]
